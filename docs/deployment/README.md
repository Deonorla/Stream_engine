...
| FlowPayAssetAttestationRegistry | configure via `FLOWPAY_RWA_ATTESTATION_REGISTRY_ADDRESS` |
...
- the RWA v2 deployment depends on the attestation registry plus the private evidence vault on the backend
