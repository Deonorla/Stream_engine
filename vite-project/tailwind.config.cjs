  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        // Stream Engine Brand Gradients
        'stream-gradient': 'linear-gradient(135deg, #3b82f6 0%, #8b5cf6 50%, #a855f7 100%)',
        'stream-subtle': 'linear-gradient(135deg, rgba(59,130,246,0.1) 0%, rgba(168,85,247,0.1) 100%)',
